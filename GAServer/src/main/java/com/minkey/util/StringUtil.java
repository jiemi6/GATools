...
public class StringUtil {
	 ...
	 * @return
	 */
	public static String byte2String(byte[] bs) throws UnsupportedEncodingException {
	...
	public static void main(String[] args) {
		...
		String  s = "apiKey=c889fc124f0a4a14ef5b01a0a8dc88c8content=6678op=Sms.sendphone=137xxxxxxxxtemplateId=1002ts=14389293864813B1F9070E32983E8";
		System.out.println(retMd5Pwd(s ));
